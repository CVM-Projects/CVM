...
namespace CVM
{
	namespace Runtime
	{
		namespace DataManage
		{
			...
			void LoadData(Environment &env, DataRegisterDynamic &dst, DataPointer src, TypeIndex dsttype);
			void LoadData(Environment &env, DataRegisterStatic &dst, DataPointer src, TypeIndex dsttype);
